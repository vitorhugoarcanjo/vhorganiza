...
def enviar_email_confirmacao(email_destino, codigo):
    ...
    try:
        msg = MIMEMultipart()
        msg['Subject'] = 'Confirme seu cadastro - Gestão de Tarefas e Finanças'
        ...
        <body style="font-family: Arial, sans-serif;">
            <h2>Bem-vindo à Gestão de Tarefas e Finanças!</h2>
            ...
            <hr>
            <small>Gestão de Tarefas e finanças - Organize suas rotinas</small>
        </body>
        </html>
        """
